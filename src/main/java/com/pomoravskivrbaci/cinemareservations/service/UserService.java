...
public interface UserService {
	...
	List<User> findUserByNameAndSurnameIgnorableCaseContaining(String name,String surname);
	List<User> findUserByNameIgnorableCaseContaining(String name);
	List<User> findUserBySurnameIgnorableCaseContaining(String surname);
