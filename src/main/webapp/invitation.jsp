...
<script type="text/javascript" src="${pageContext.request.contextPath}/invitation.js"> </script>
...
<body>
  	...
  	<c:if test="${loggedUser.email==user.email}">
	  		...
	  		<p>Your friend ${friend.name} ${friend.surname} invited you on this event:</p>
  		<table border="1">
  			<tr>
  				<td>Institution</td>
